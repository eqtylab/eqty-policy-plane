...
const ServerCard = () => {
  return (
    <div>
      <div className="tw-py-4 tw-mr-16 tw-rounded-lg tw-pl-7 tw-pr-4 tw-bg-gradient-to-r tw-from-card-1 tw-from-[-30%] tw-to-card-2 tw-backdrop-blur-sm">
        <div className="tw-pb-4 tw-border-b tw-border-black">
          ...
          <h2 className="tw-text-base">Ireland East - Dublin</h2>
        </div>
        ...
        <div className="tw-bg-[#D3E660] tw-p-2 ">
          <NvidiaIcon />
          <h2 className="tw-pt-6 tw-pb-12 tw-text-base tw-font-semibold tw-text-center tw-text-black">
            H100
          </h2>
        </div>
        <div className="tw-bg-[#4F99E9] tw-px-3 tw-py-6 tw-grid tw-grid-cols-3 tw-gap-2 ">
          <IntelIcon />
          <h2 className="tw-text-base tw-font-semibold tw-text-center tw-text-black ">
            XEON 5
          </h2>
        </div>
      </div>
