...
import { PipelineState, PipelineStatus } from './types';
import { pipelineReducer, PipelineAction } from './pipelineReducer';
import { PipelineOrchestrator } from './PipelineOrchestrator';
import { pipelineConfig } from './demo-simulation-pipeline';
...
const initialState: PipelineState = {
    status: 'idle',
    nodes: Object.keys(pipelineConfig.nodes).reduce((acc, nodeId) => ({
        ...acc,
        [nodeId]: {
            status: 'idle',
            logs: [],
